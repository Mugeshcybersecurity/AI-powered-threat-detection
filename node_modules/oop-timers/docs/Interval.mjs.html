...
<head>
    ...
    <meta charset="utf-8">
    <title>Interval.mjs - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title">Interval.mjs</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>import validateTime from "./validateTime.mjs";
