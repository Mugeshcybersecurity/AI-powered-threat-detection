...
var _oopTimers = require("oop-timers");
...
var _index2 = _interopRequireDefault(require("./request/index"));
...
class ApiClient {
  ...
  request(method, url, queryParams, body, options = {}) {
    ...
    const future = new Promise((resolve, reject) => {
      ...
      return (async () => {
        ...
        while (fineOptions.retryPolicy({
          ...
          const singleTimeout = new _oopTimers.Timeout(() => {
    ...
    if (fineOptions.totalTimeout > 0 && Number.isFinite(fineOptions.totalTimeout)) {
      globalTimeout = new _oopTimers.Timeout(globalBreak, fineOptions.totalTimeout, true);
    }
  ...
  async _request(method, originalUrl, queryParams, options, signal) {
    ...
    const response = await (0, _index.default)(result, type, request);
