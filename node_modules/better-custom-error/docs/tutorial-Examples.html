...
<h2>Native solution doesn't work as expected</h2>
<pre class="prettyprint source lang-javascript"><code>const MyError = createError(&quot;MyError&quot;);
...
<h2>Custom error details object simplifies passing custom data</h2>
<pre class="prettyprint source lang-javascript"><code>throw new MyCustomError(&quot;Cannot do stuff&quot;, { debugStats: databaseEngine.stats() });
...
<h2>Create instance basing on another instance</h2>
...
<h2>Pass data in any order, pass null or undefined for simplicity</h2>
<pre class="prettyprint source lang-javascript"><code>let customData = LOGGING_LEVEL === &quot;ALL&quot; ? { time: db.time(), query: query } : null;
throw new DatabaseError(customData, &quot;Query cannot run&quot;);
</code></pre>
<h2>Advanced usage and <code>names</code> property</h2>
<p>This shows advanced usage of custom errors. I tried to show most features in tiny part of code, so it's a little messy.
...
<p>For logging purposes we're casting it to string and still be able to see hierarchy, we will get:</p>
